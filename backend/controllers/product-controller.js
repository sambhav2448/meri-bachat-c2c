...
const fkart = require('../scraping-api/flipkart-ch');
const amz = require('../scraping-api/reliance-ch');
const croma = require('../scraping-api/paytm-ch');

const getflipkart = async (req, res) => {
  const url = req.body.url;

  try {
    const fdata = await fkart(url);
